...
def get_database_connection_string():
    ...
    # For PostgreSQL, we need to ensure the driver is correct
    elif database_url.startswith("postgresql://"):
        # Replace with the psycopg2 driver for sync operations or asyncpg for async
...
async def create_tables():
    ...
    try:
        # Try importing from models first
        from models import Task  # Import here to avoid circular imports
    except ImportError:
        # If models fails, try importing from task_models
